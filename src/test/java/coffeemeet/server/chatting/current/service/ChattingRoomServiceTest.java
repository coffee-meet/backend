...
//    given(userQuery.getUsersByRoom(chattingRoom)).willReturn(chattingRoomUsers);
//    given(
//        chattingRoomMigrationProcessor.backUpChattingRoom(chattingRoom, chattingRoomUsers)).willReturn(
//        chattingRoomHistory);
//
//    // when
...
//    then(chattingRoomMigrationProcessor).should()
//        .migrateChattingMessagesToHistoryInChattingRoom(chattingRoom, chattingRoomHistory,
//            chattingRoomLastMessageId);
//    then(chattingRoomMigrationProcessor).should().deleteChattingRoom(chattingRoom, chattingRoomUsers);
//  }
//
