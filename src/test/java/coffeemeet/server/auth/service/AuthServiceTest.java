...
class AuthServiceTest {
  ...
  void renewTest() {
    ...
    // when
    AuthTokens renewedAuthTokens = authService.renew(Faker.instance().random().nextLong(),
        REFRESH_TOKEN);
  ...
  void renewFailTest() {
    ...
    // when, then
    assertThatThrownBy(() -> authService.renew(Faker.instance().random().nextLong(), REFRESH_TOKEN))
