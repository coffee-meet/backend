...
import coffeemeet.server.chatting.history.domain.repository.ChattingMessageHistoryJdbcRepository;
...
public class ChattingMessageHistoryRepositoryImpl implements
    ChattingMessageHistoryJdbcRepository {
